...
def run_train():
    ...
    log.write('----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n')
    log.write('mode    rate    iter  epoch | CinC                    | loss  | IAVB      | AF        | AFL       | Brady     | IRBBB     | LAnFB     | LAD       | LBBB      | LQRSV     | NSIVCB    | PR        | PAC       | PVC       | LPR       | LQT       | QAb       | RAD       | RBBB      | SA        | SB        | SNR       | STach     | TAb       | TIn       | abQRS     | LVH       | MI        | MIs       | NSSTTA    | STD       | VEB       | AnMIs     | AnMI      | IIs       | LIs       | LAE       | OldMI     | STC       | STE       | STIAb     | Others    | time        \n')
    log.write('----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n')
    ...
    def message(rate, iter, epoch, CinC, loss, precision, recall, mode='print', train_mode = 'train'):
        ...
        text = \
            ...
            '%4.3f | '%loss +\
            '%0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | '%(*precision_recall, ) +\
    ...
    while  iter<num_iters:
        ...
        for t, (input, truth, infor) in enumerate(train_loader):
            ...
            if (iter % iter_valid==0):
                CinC, valid_loss, valid_precision, valid_recall = do_valid(net, valid_loader) #
                pass
