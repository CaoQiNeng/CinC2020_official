...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, stride=1, shortcut=None):
        ...
        self.left = nn.Sequential(
            nn.Conv2d(in_channel, out_channel, kernel_size=(25, 1), stride=stride, padding=(12, 0), bias=False),
            nn.BatchNorm2d(num_features=out_channel),
            nn.ReLU(inplace=True),
            nn.Conv2d(out_channel, out_channel, kernel_size=(25, 1), stride=1, padding=(12, 0), bias=False),
            nn.BatchNorm2d(num_features=out_channel)
        )
...
class Net(nn.Module):
    ...
    def __init__(self, inplanes, planes):
        ...
        self.pre = nn.Sequential(
            ...
            # nn.Dropout(0.7),
            # nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=inplanes, out_channels=64, kernel_size=(25, 1), stride=1, padding=(12,0), bias=False),
