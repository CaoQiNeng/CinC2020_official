...
class Net(nn.Module):
    ...
    def __init__(self, in_planes, num_classes=1000, kernel_size=25, dropout_rate = 0.5):
        ...
        self.maxpool_t = nn.MaxPool1d(kernel_size=self.kernel_size, stride=2, padding=int(self.kernel_size / 2))
