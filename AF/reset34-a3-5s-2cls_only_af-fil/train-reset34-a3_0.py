...
def run_train():
    train_fold = 3
    valid_fold = 0
    out_dir = ROOT_PATH + '/CinC2020_official_logs/result-reset34-a%d_%d-5s-2cls_only_af-fil'%(train_fold, valid_fold)
    ...
    train_dataset = CinCDataset(
        ...
        data_path=DATA_DIR + '/data_argument/5s_fil_a3_0/train_data'
    )
    ...
    val_dataset = CinCDataset(
        ...
        csv='train.csv',
        split='valid_a%d_687.npy' % 0,
        data_path=DATA_DIR + '/data_argument/5s_fil_a3_0/valid_data'
    )
