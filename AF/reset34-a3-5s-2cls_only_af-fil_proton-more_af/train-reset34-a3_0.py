...
from dataset_only_af_5s_no_merge_fil_proton_more_af import *
...
def run_train():
    train_fold = 3
    valid_fold = 0
    out_dir = ROOT_PATH + '/CinC2020_official_logs/result-reset34-a%d_%d-5s-2cls_only_af-fil_proton-more_af'%(train_fold, valid_fold)
