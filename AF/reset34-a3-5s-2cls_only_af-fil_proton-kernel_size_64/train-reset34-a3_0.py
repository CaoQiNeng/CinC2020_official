...
from common  import *
from model_resnet34_kernel_size_64 import *
...
def run_train():
    train_fold = 3
    valid_fold = 0
    out_dir = ROOT_PATH + '/CinC2020_official_logs/result-reset34-a%d_%d-5s-2cls_only_af-fil_proton-kernel_size_64'%(train_fold, valid_fold)
