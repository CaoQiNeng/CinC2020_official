...
def run_train():
    train_fold = 3
    valid_fold = 0
    out_dir = ROOT_PATH + '/CinC2020_official_logs/result-reset34-a%d_%d-5s-2cls_only_af-3fil-lr0.01'%(train_fold, valid_fold)
    initial_checkpoint = None
    initial_checkpoint = ROOT_PATH + '/CinC2020_official_logs/result-reset34-a%d_%d-5s-2cls_only_af-3fil/checkpoint/00018400_model.pth'%(train_fold, valid_fold)
