...
from dataset_only_af_5s import *
...
def run_train():
    train_fold = 0
    valid_fold = 0
    out_dir = ROOT_PATH + '/CinC2020_official_logs/result-reset34-a%d_%d-first_5s_merge-2cls_only_af-batch_32'%(train_fold, valid_fold)
