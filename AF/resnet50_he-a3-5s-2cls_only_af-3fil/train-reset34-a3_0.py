...
def run_train():
    train_fold = 3
    valid_fold = 0
    out_dir = ROOT_PATH + '/CinC2020_official_logs/result-resnet50_he-a%d_%d-5s-2cls_only_af-3fil'%(train_fold, valid_fold)
    ...
    while  iter<num_iters:
        ...
        for t, (input, truth, infor) in enumerate(train_loader):
            ...
            top_loss = np.array([0.012 for i in range(10)])
