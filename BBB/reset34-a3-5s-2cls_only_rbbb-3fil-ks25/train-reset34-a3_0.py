...
from dataset_only_rbbb_5s_no_merge_fil_proton import *
...
def run_train():
    train_fold = 3
    valid_fold = 0
    out_dir = ROOT_PATH + '/CinC2020_official_logs/result-reset34-a%d_%d-5s-2cls_only_rbbb-3fil-ks25'%(train_fold, valid_fold)
