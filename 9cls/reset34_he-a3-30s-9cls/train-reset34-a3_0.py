...
def run_train():
    ...
    valid_fold = 0
    global out_dir
    out_dir = ROOT_PATH + '/CinC2020_official_logs/result-reset34_he-a%d_%d-30s-9cls'%(train_fold, valid_fold)
    initial_checkpoint = None
    initial_checkpoint = ROOT_PATH + '/CinC2020_official_logs/result-reset34_he-a%d_%d-30s-9cls/checkpoint/00044000_model.pth'%(train_fold, valid_fold)
