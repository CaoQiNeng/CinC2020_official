...
stat_df = pd.DataFrame( columns = [164889003, 270492004, 164909002, 426783006, 59118001, 284470004,  164884008,  429622005, 164931005])
target = 'PhysioNetChallenge2020_PTB-XL_label_SNOMED'
...
stat_df.to_csv(DATA_ROOT_PATH + '/CinC2020_V1/Label_Distri' + target + '.csv')
